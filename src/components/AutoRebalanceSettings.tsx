            ...
            <>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full h-2 bg-slate-200 dark:bg-gray-700 rounded-lg appearance-none cursor-pointer accent-brand-600"
                />
              ...
              <div className="p-3 bg-brand-50 dark:bg-brand-900/20 rounded-lg border border-brand-200 dark:border-brand-700">
                <div className="flex items-start gap-2">
                  <CheckCircle className="text-brand-600 flex-shrink-0 mt-0.5" size={16} />
