...
const ACHIEVEMENT_DEFINITIONS = [
  {
    ...
    icon: 'TrendingUp',
    condition: (stats: AchievementStats) => stats.totalHoldings >= 1,
  },
  {
    type: 'diversified_5',
    ...
    icon: 'Grid',
    condition: (stats: AchievementStats) => stats.totalHoldings >= 5,
  },
  {
    type: 'diversified_10',
    ...
    icon: 'Award',
    condition: (stats: AchievementStats) => stats.totalHoldings >= 10,
  },
  {
    type: 'profit_10k',
    ...
    icon: 'DollarSign',
    condition: (stats: AchievementStats) => stats.totalPnL >= 10000,
  },
  {
    type: 'profit_50k',
    title: 'Büyük Kazanç',
    ...
    icon: 'TrendingUp',
    condition: (stats: AchievementStats) => stats.totalPnL >= 50000,
  },
  {
    type: 'portfolio_100k',
    title: 'Altı Haneli',
    ...
    icon: 'Target',
    condition: (stats: AchievementStats) => stats.totalValue >= 100000,
  },
  {
    type: 'portfolio_500k',
    title: 'Yarım Milyon',
    ...
    icon: 'Star',
    condition: (stats: AchievementStats) => stats.totalValue >= 500000,
  },
  {
    type: 'portfolio_1m',
    title: 'Milyoner',
    ...
    icon: 'Crown',
    condition: (stats: AchievementStats) => stats.totalValue >= 1000000,
  },
  {
    type: 'all_types',
    title: 'Tam Set',
    ...
    icon: 'Package',
    condition: (stats: AchievementStats) => stats.assetTypes.length >= 6,
  },
  {
    ...
    icon: 'Calendar',
    condition: (stats: AchievementStats) => stats.positiveDays >= 30,
  },
  {
    ...
    icon: 'Gift',
    condition: (stats: AchievementStats) => stats.totalDividends > 0,
  },
  {
    type: 'active_trader',
    ...
    icon: 'Activity',
    condition: (stats: AchievementStats) => stats.totalTransactions >= 50,
  },
];
...
export async function checkAndUnlockAchievements(stats: AchievementStats) {
  const now = Date.now();
...
export async function getAchievementProgress(stats: AchievementStats) {
